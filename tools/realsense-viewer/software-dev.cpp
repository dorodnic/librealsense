...
python_device::python_device()
{
    ...
    _depth = _sensor.add_video_stream({ RS2_STREAM_DEPTH, 1, 2,
        W, H, 30, 2,
        RS2_FORMAT_Z16, depth_intrinsics });

    _depth_orig = _sensor.add_video_stream({ RS2_STREAM_DEPTH, 2, 3,
        W, H, 30, 2,
        RS2_FORMAT_Z16, depth_intrinsics });

    _left = _sensor.add_video_stream({ RS2_STREAM_INFRARED, 1, 0,
        W, H, 30, 1,
        RS2_FORMAT_Y8, depth_intrinsics });

    _right = _sensor.add_video_stream({ RS2_STREAM_INFRARED, 2, 1,
        W, H, 30, 1,
        RS2_FORMAT_Y8, depth_intrinsics });

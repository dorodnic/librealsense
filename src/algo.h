...
namespace librealsense
{
    ...
    public:
        ...
        filter_mode get_filter_mode() const { return filter; }
        ...
        void set_filter_mode(filter_mode m) { filter = m; }
    ...
    private:
        ...
        inline void im_hist(const uint8_t* data, const region_of_interest& image_roi, const int rowStep, float h[]);
        ...
        void histogram_score(std::vector<float>& h, const int total_weight, histogram_metric& score);
        ...
        int direction = 0, prev_direction = 0; float hysteresis = 0.05f;// 05;
